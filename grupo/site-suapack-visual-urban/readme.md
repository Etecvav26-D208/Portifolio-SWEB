# 🛍️ SUA PACK — CHECKLIST DO PROJETO

## 🔧 PHP / ADMIN

- [x] Fazer PHP do cadastro de categorias
- [x] Fazer PHP da listagem de categorias
- [x] Fazer PHP da edição de categorias
- [x] Fazer PHP da exclusão de categorias

- [x] Fazer PHP do cadastro de produtos
- [x] Fazer PHP da listagem de produtos
- [x] Fazer PHP da edição de produtos
- [x] Fazer PHP da exclusão de produtos

- [x] Fazer PHP do cadastro de pedidos
- [x] Fazer PHP da listagem de pedidos
- [x] Fazer PHP da edição de pedidos
- [x] Fazer PHP da exclusão de pedidos
- [x] Fazer PHP da visualização dos pedidos
